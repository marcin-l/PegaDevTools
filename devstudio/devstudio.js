...
newEditableDiv.id = "PegaDevToolsNotes";
newEditableDiv.contentEditable = true;
newEditableDiv.style.width = "25%";
newEditableDiv.style.backgroundColor = "#f0f0f0";
newEditableDiv.style.display = "none";
newEditableDiv.style.transition = "transform 0.5s ease-in-out";
newEditableDiv.style.position = "fixed";
newEditableDiv.style.left = "8px";
newEditableDiv.style.top = "340px";
newEditableDiv.style.bottom = "40px";
newEditableDiv.style.padding = "4px";

document.querySelector("footer div.content-item").prepend(newButton);
document.body.appendChild(newEditableDiv);

newButton.addEventListener("click", () => {
  let notes = document.querySelector("div#PegaDevToolsNotes");
  if (notes.style.display === "none") {
    notes.style.display = "block";
    //notes.style.transform = "translateY(-100%)";
  } else {
